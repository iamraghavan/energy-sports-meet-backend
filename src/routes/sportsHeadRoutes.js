    ...
    router.post('/teams/:teamId/players/bulk', sportsHeadController.bulkAddPlayers); // Original Route
    router.post('/teams/:teamId/members/bulk', sportsHeadController.bulkAddPlayers); // Alias to match frontend
